...
export default function PatientLoginPage() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    const user = existingUsers.find((u: any) => u.email === email && u.password === password && u.role === 'patient');
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center bg-background px-4">
      <div className="glass p-8 md:p-12 rounded-3xl w-full max-w-md shadow-2xl">
        <h1 className="text-3xl font-extrabold text-center mb-2">Patient Login</h1>
        <p className="text-slate-500 text-center mb-8">Sign in to your Patient account</p>
